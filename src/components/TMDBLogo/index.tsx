...
export const TMDBLogo = (props: SvgProps) => (
  <View style={{ aspectRatio: 190 / 81 }}>
    <Svg fill="none" height="100%" viewBox="0 0 190.24 81.52" width="100%" {...props}>
      <Defs>
        <LinearGradient gradientUnits="userSpaceOnUse" id="a" x2={190.24} y1={40.76} y2={40.76}>
      ...
      <G data-name="Layer 2">
        <Path
          ...
          data-name="Layer 1"
          // @ts-expect-error (need this style)
          style={{
            fill: 'url(#a)',
          }}
        />
